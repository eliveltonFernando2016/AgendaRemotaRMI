...
public class CompromissoGUI extends javax.swing.JDialog {
    public enum ActionType {ADD,CANCEL, UPDATE};
    ...
    private void initComponents() {
        ...
        textFieldData.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter()));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(textFieldData, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public Compromisso obtemDados() throws RemoteException{
        boolean notificacao = false;
        if(textFieldNotificacao.getText().equals("SIM")){
            notificacao = true;
        }

        compromisso = new Compromisso(0, textFieldData.getText(), textFieldHora.getText(), textFieldAssunto.getText(), textFieldDescricao.getText(), notificacao);
        this.limparCampos();
        return compromisso;
    }
    
    public void recuperaDados(Compromisso compromisso){
        buttonAdicionar.setText("Alterar");
        setTitle("Alterar Compromisso");
        
        textFieldData.setText(compromisso.getData());
        textFieldHora.setText(compromisso.getHora());
        textFieldAssunto.setText(compromisso.getAssunto());
        textFieldDescricao.setText(compromisso.getDescricao());

        if(compromisso.getNotificacao()){
